...
<body>
    ...
    <div class="w-20 bg-gray-50 h-screen fixed right-0 xs:hidden md:block">
    ...
    <div class="w-60 h-screen fixed bg-white right-20 z-20 hidden">
        <div class="px-5">
    ...
    <div class="md:mr-20 bg-gray-light h-full">
        <div class="w-full flex flex-row-reverse">
            <div class="md:px-16 xs:px-4 w-full mt-14 md:mt-0">
                <div class="header flex justify-between flex-row-reverse my-4">
                    <div class="">
                        <span
