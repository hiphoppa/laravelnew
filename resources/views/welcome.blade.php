...
<body>
    ...
    <div class="w-20 bg-gray-50 h-full absolute right-0 xs:hidden md:block">
    ...
    <div class="top-14 bg-white h-screen w-68 right-0 fixed z-20 hidden">
        ...
        <div class="bg-gray-50 h-full custom-menu-width absolute left-0">
            <div class="rtl">
                <div class="pt-4 flex">
                    <div class="inline-block mr-4">
    ...
    <div class="w-60 h-screen fixed bg-white right-20 z-20">
        <div class="px-5">
            <div class="mt-4 mx-auto items-center flex flex-row">
                <div class="cursor-pointer flex items-center mr-4 bg-green-200 w-8 h-8 rounded-full justify-center">
                    <span class="text-green-500 text-xs font-bold ">H</span>
                </div>
                <div class="inline-block mr-4">
